const About = () => {
  return (
    <div id="About" className="py-16 px-4 space-y-6">
      <div className="mt-4 space-y-2">
        <p className="text-background-300 tracking-[0.20rem] text-sm">- MI NOMBRE ES</p>
        <h1 className="text-2xl font-medium text-background-300"><span className="text-primary-100">Roy Huaman</span> - <span className="text-complementary-100">Frontend Developer</span></h1>
      ...
      <button className="bg-primary-100 text-background-100 w-full rounded-lg py-2 font-medium flex place-content-center gap-1">
      ...
      <div className="border-2 border-background-300 overflow-hidden rounded relative">
